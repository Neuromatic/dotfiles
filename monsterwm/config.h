...
static const char *muttcmd[] = { "urxvtc", "-name", "mutt", "-e", "mutt", NULL };
static const char *volup[]   = { "volup.sh", NULL };
static const char *voldwn[]  = { "voldwn.sh", NULL };
static const char *menucmd[] = { "dmenu_run", "-nb", "#000000", "-nf", "#aaaaaa", "-sb", "#000000", "-sf", "#ffffff", "-fn", "-*-terminus-medium-r-*-*-12-*-*-*-*-*-*-*", NULL };
